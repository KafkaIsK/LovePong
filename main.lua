...
function love.update(dt)
    ...
    elseif AI_ENABLED == true then
        if ball.x > VIRTUAL_WIDTH / 2 and ball.dx > 0 then
            ...
            if player2.y > (VIRTUAL_HEIGHT  - player2.height) / 2 then
                player2.dy = -PADDLE_SPEED / 3
            elseif player2.y < (VIRTUAL_HEIGHT - player2.height) / 2 then
                player2.dy = PADDLE_SPEED / 3
            else
                player2.dy = 0
            end
...
function love.draw()
    ...
    if gameState == 'start' then
        ...
        love.graphics.printf('Press P to toggle AI', 0, 30, VIRTUAL_WIDTH, 'center')
    elseif gameState == 'serve' then
        -- UI messages
        love.graphics.setFont(smallFont)
...
function displayAI()
    love.graphics.setFont(smallFont)
    if AI_ENABLED == false then
        love.graphics.print('Player2 AI off', 10, 20)
    elseif AI_ENABLED == true then
        love.graphics.print('Player2 AI on', 10, 20)
    end
end